...
class Post(db.Model):
    __searchable__ = ['title','content','subtitle']
    id = db.Column(db.Integer, primary_key=True)
    ...
    time_limit1 = db.Column(db.Integer(),nullable = True)
    time_limit2 = db.Column(db.Integer(),nullable = True)
    url_slug = db.Column(db.String(255),nullable = True)
